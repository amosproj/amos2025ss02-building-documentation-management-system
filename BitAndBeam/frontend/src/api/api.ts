 ...
 * @export
 */
export const BuildINGApiAxiosParamCreator = function (
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['BuildINGApi.getWeatherForecast']?.[
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BuildINGApi.rootGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const BuildingsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    apiBuildingsIdDelete: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('apiBuildingsIdDelete', 'id', id);
      const localVarPath = `/api/Buildings/{id}`.replace(
        `{${'id'}}`,
 ...
 * @export
 */
export const BuildingsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    apiBuildingsDebugDbGet(options?: any): AxiosPromise<void> {
      return localVarFp
        .apiBuildingsDebugDbGet(options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    apiBuildingsDebugFullGet(options?: any): AxiosPromise<void> {
      return localVarFp
        .apiBuildingsDebugFullGet(options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    apiBuildingsIdDelete(id: number, options?: any): AxiosPromise<void> {
      return localVarFp
        .apiBuildingsIdDelete(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    apiBuildingsIdPut(
      ...
      return localVarFp
        .apiBuildingsIdPut(id, building, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class BuildingsApi extends BaseAPI {
  ...
  public apiBuildingsDebugDbGet(options?: RawAxiosRequestConfig) {
    return BuildingsApiFp(this.configuration)
      .apiBuildingsDebugDbGet(options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const DocumentsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiDocumentsIdDelete: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('apiDocumentsIdDelete', 'id', id);
      const localVarPath = `/api/Documents/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    apiDocumentsIdDownloadGet: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('apiDocumentsIdDownloadGet', 'id', id);
      const localVarPath = `/api/Documents/{id}/download`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    apiDocumentsIdPreviewGet: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('apiDocumentsIdPreviewGet', 'id', id);
      const localVarPath = `/api/Documents/{id}/preview`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DocumentsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiDocumentsGet(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdDelete(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsIdDelete']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiDocumentsIdDownloadGet(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdDownloadGet(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsIdDownloadGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdGet(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsIdGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiDocumentsIdPreviewGet(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdPreviewGet(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsIdPreviewGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdPut(
          id,
          documentUpdateRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsIdPut']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsPost(file, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsPost']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const DocumentsApiFactory = function (
  ...
  return {
    ...
    apiDocumentsIdPreviewGet(id: number, options?: any): AxiosPromise<void> {
      return localVarFp
        .apiDocumentsIdPreviewGet(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    apiDocumentsIdPut(
      ...
      return localVarFp
        .apiDocumentsIdPut(id, documentUpdateRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const OllamaApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiOllamaAskPost(
          ollamaRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['OllamaApi.apiOllamaAskPost']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const OllamaApiFactory = function (
  ...
  return {
    ...
    apiOllamaAskPost(
      ...
      return localVarFp
        .apiOllamaAskPost(ollamaRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
