...
namespace Build.ING.Migrations
{
    ...
    [Migration("20250630000134_RemoveCategoryId_UseCategoryString")]
    partial class RemoveCategoryId_UseCategoryString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BUILD.ING.Models.Document", b =>
                {
                    ...
                    b.Property<JsonDocument>("KeyInformation")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("BUILD.ING.Models.Document", b =>
                {
                    b.HasOne("BUILD.ING.Models.Building", null)
                        .WithMany()
                        .HasForeignKey("BuildingId")
                        .OnDelete(DeleteBehavior.Cascade);
